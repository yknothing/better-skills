...
#
# "The gate actually fails" is a load-bearing claim of bs-ppt-master, so it
# needs an assertion rather than a promise. A Gate 2 review of this checker produced a
