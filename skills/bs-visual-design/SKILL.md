---
name: bs-visual-design
# tier: deep
description: Use when the user asks to design a UI, create a visual design, design a page or screen, style a component, or establish a visual direction. Covers layout, color, typography, spacing, imagery, and interaction states. Deep-tier: exhaustive precision for a high-frequency, high-failure-cost domain.
---
