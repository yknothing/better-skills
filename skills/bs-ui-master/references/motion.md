<!-- Parent skill: skills/bs-ui-master/SKILL.md -->
...
This file defines tokens and gates for `bs-ui-master`. For expert motion **implementation**, **strict diff review**, or **effect naming**, use Reference skills from [emilkowalski/skills](https://github.com/emilkowalski/skills) (synced via `external/sources.yaml`):
