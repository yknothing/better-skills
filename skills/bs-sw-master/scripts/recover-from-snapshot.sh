...
# Purpose: Restore the working tree to a previously created bs-sw-master safety snapshot,
...
case "$target" in
  ...
  *)                       echo "  # Ref '$target' is not a bs-sw-master snapshot; delete manually if appropriate." ;;
esac
