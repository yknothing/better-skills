---
name: bs-skill-bootstrap
description: Use when the user wants to create a new agent skill from scratch, from idea to registered, validated SKILL.md.
# tier: standard
---
...
This skill does NOT:
- Modify existing skills (use bs-skill-health for audits and fixes).
