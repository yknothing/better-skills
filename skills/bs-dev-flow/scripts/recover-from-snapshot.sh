...
# Purpose: Restore the working tree to a previously created bs-dev-flow safety snapshot,
...
case "$target" in
  ...
  *)                       echo "  # Ref '$target' is not a bs-dev-flow snapshot; delete manually if appropriate." ;;
esac
