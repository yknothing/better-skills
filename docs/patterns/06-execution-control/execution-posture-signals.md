...
- `dev-flow` — Execution Posture Signals table maps each signal string to its pipeline phase: "Writing failing test for [criterion]" → Phase 3: RED, "Tests pass. Running full suite." → GREEN confirmed, "Committing: [type]: [summary]" → Phase 7.
