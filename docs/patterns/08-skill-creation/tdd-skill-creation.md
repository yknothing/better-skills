...
- Every new skill creation. This is a required pattern in `bs-skill-forge` Step 5.
...
The full procedure (RED-GREEN-REFACTOR, control-prompt comparison, adversarial loophole audit) lives in `skills/bs-skill-forge/references/tdd-for-skills.md`.
