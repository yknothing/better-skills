...
- **10 self-developed skills** under `skills/`: `bs-requirements-engineering`, `bs-first-customer-finder`, `bs-visual-design`, `bs-dev-flow`, `bs-prose-craft`, `bs-article-illustrate`, `bs-social-card`, `bs-skill-bootstrap`, `bs-skill-health`, `bs-ppt-architecture`
...
| 19 | `bs-ppt-architecture` | Build | deep | Design |
