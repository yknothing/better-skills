...
function copyTree(absSourceDir, destDir, { dryRun = false, canonicalName = null, aliases = {} } = {}) {
...
function ensureExternalCached(sourceName, sourceMeta, upstreamSkillName) {
  ...
  const targetSkillDir = isRootLevelSkill
    ? cacheDir
    : path.join(cacheDir, skillsPath, upstreamSkillName);
